...
| 2026-03-25 | Public docs route added     | `app/src/app/app.routes.ts` (updated), `app/src/app/app.ts` (updated), `app/src/app/app.html` (updated), `app/src/app/home/home.component.ts` (new), `app/src/app/home/home.component.html` (new), `app/src/app/home/home.component.css` (new), `app/src/app/docs/docs.component.ts` (new), `app/src/app/docs/docs.component.html` (new), `app/src/app/docs/docs.component.css` (new), `app/public/project-docs.md` (new) | Added a publicly accessible documentation page at `/docs`. The page renders markdown from a static asset so anyone can read project documentation directly in the running app.                                                                                                                               |
